define([
...
], function(Backbone, M_banner, C_productList, V_banner, V_tab, V_offLineProductList, V_onLineProductList, V_errorPic,V_movie,tpl) {
    return Backbone.View.extend({
        ...
        initialize: function() {
            ...
            /*创建视图实例*/
            var point = [{eventid:"约影票",label:"约影票首页_点击_猜你喜欢",param:{}},{eventid:"约影票",label:"约影票首页_点击_周边影院",param:{}}]
        ...
        getCircumData: function() {
            ...
            Router.getLocation(function(nativeData) {
                var reqData = [{
                    ...
                    "cityId": nativeData.cityId || 520400,
                    "destLat": nativeData.lat || nativeData.lat,
                    ...
                    "offset":offset,
                    "limit": "10",
                    "filters":[{"grp":"分类","items":[{"caption":"电影","value":"电影"}]}]
                }];
                Router.getFocusBank(function(banks) {
